...
| [BUG-0013](bugs/BUG-0013-streamlit-settings-drawer-black-main-view.md) | Fixed | P1 High | Streamlit UI, Settings | Opening the Streamlit settings drawer on desktop could turn the main view into a blank black surface. | Smoke desktop settings drawer open/close before marking verified. |
