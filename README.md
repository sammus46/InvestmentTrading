...
- Streamlit watchlists persist to `~/.investment_trading/streamlit_state.json` by default, are scoped by available user identity plus browser/device context, and auto-refresh loaded data every 5 minutes.
